            ...
            <div className="services__container">
                ...
                <div className="services__content">
                    ...
                    <ul className="bullets">
                        <li>Backend Response Hendling</li>
                        <li>Single Page Applications</li>
                        <li>ReactJS Websites</li>
                    </ul>
                    <a href="https://github.com/FasihShahbaz1999" className="home__social-icon" target="_blank" rel="noreferrer">
                    <img src={Github} alt="github" id="icon" />
                    </a>
                    <a href="https://www.fiverr.com/fasih_shahbaz/develop-restful-api-using-nodejs-and-mongodb" className="home__social-icon" target="_blank">
